...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'product-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    {
      name: 'Product Delivery Company',
      path: '/product-delivery-companies',
      entity: 'product_delivery_company',
      service: AccessServiceEnum.PROJECT,
      icon: FiBox,
    },
    {
      name: 'Product Social Network',
      path: '/product-social-networks',
