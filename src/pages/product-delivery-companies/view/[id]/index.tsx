...
import { getProductDeliveryCompanyById } from 'apiSdk/product-delivery-companies';
...
function ProductDeliveryCompanyViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Product Delivery Company Detail View
          </Text>
          {hasAccess('product_delivery_company', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/product-delivery-companies/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              ...
              {hasAccess('delivery_company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/delivery-companies/view/${data?.delivery_company?.id}`}>
...
)(ProductDeliveryCompanyViewPage);
